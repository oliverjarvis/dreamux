...
final class TestSandbox {
    ...
    init() throws {
        root = FileManager.default.temporaryDirectory
            .appendingPathComponent("ClayspaceTests-\(UUID().uuidString)", isDirectory: true)
...
enum RepoFixtures {
    ...
    static var root: URL {
        URL(fileURLWithPath: #filePath)        // .../Tests/ClayspaceTests/Support/TestSandbox.swift
            .deletingLastPathComponent()        // .../Tests/ClayspaceTests/Support
            .deletingLastPathComponent()        // .../Tests/ClayspaceTests
