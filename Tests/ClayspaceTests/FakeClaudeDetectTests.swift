...
final class FakeClaudeDetectTests: XCTestCase {
    ...
    func testDetectWritesRunTOMLThatParsedRunnerAccepts() async throws {
        ...
        // Commit copies of both sample apps into the Clayspace
        ...
        let result = try await runProcess(
            ...
            arguments: ["Inspect every repo under ./repos/* and write .clayspace/run.toml"],
        ...
        let tomlURL = project.rootPath
            .appendingPathComponent(".clayspace/run.toml")
